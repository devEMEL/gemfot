...
const ARC_TESTNET_NETWORK_NAME = 'arc-testnet'
...
export function getSubgraphConfig(): SubgraphConfig {
  ...
  if (selectedNetwork == ARC_TESTNET_NETWORK_NAME) {
    return {
      // Lock Bundle.ethPriceUSD to $1 SINCE ARC USES USDC AS NATIVE TOKEN
      poolManagerAddress: '0xc8d4d8fd9121d92ba790a70a60c07143a2c0cd98',
      stablecoinWrappedNativePoolId: '0xded13ea4af92ba259aced8cebeddb62edc8e46bf4aaa600c708a904d2fcf3c0d', 
      // USDC/mUSDC
      // USDC - NATIVE
      // mUSDC - STABLECOIN
      stablecoinIsToken0: false,
      wrappedNativeAddress: '0x3600000000000000000000000000000000000000', // USDC ADDRESS
      minimumNativeLocked: BigDecimal.fromString('1'),
      stablecoinAddresses: [
        '0x3600000000000000000000000000000000000000', // USDC
        '0x36bee8f2df69cf3afab5c5cca973feb6441cab11', // mUSDC
