...
export class Memecoin__eip712DomainResult {
  value0: Bytes;
  value1: string;
  value2: string;
  value3: BigInt;
...
export class Memecoin extends ethereum.SmartContract {
  ...
  eip712Domain(): Memecoin__eip712DomainResult {
    let result = super.call(
      "eip712Domain",
    ...
    return new Memecoin__eip712DomainResult(
      result[0].toBytes(),
      result[1].toString(),
      result[2].toString(),
      result[3].toBigInt(),
  ...
  try_eip712Domain(): ethereum.CallResult<Memecoin__eip712DomainResult> {
    let result = super.tryCall(
      "eip712Domain",
      "eip712Domain():(bytes1,string,string,uint256,address,bytes32,uint256[])",
      [],
    ...
    return ethereum.CallResult.fromValue(
      new Memecoin__eip712DomainResult(
        value[0].toBytes(),
        value[1].toString(),
        value[2].toString(),
        value[3].toBigInt(),
  ...
  launch(): Address {
    let result = super.call("launch", "launch():(address)", []);

    return result[0].toAddress();
  }

  try_launch(): ethereum.CallResult<Address> {
    let result = super.tryCall("launch", "launch():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
