...
// import { Initialize } from '../../src/generated/PoolManager/PoolManager'
// import { Bundle, Pool } from '../../src/generated/schema'
...
//     )
//     assertObjectMatches('Token', USDC_MAINNET_FIXTURE.address, [['derivedUSDC', expectedToken0Price.toString()]])
...
//       TEST_CONFIG.minimumNativeLocked,
//     )
//     assertObjectMatches('Token', WETH_MAINNET_FIXTURE.address, [['derivedUSDC', expectedToken1Price.toString()]])
//   })
// })
...
//     const token1 = createAndStoreTestToken(WETH_MAINNET_FIXTURE)
//     token1.derivedUSDC = BigDecimal.fromString('10')
//     token1.save()
