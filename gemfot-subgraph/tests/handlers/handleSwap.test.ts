...
// import { Swap } from '../../src/generated/PoolManager/PoolManager'
// import { Bundle, Token } from '../../src/generated/schema'
...
//     usdcEntity.derivedUSDC = TEST_USDC_DERIVED_ETH
//     usdcEntity.save()

//     const wethEntity = Token.load(WETH_MAINNET_FIXTURE.address)!
//     wethEntity.derivedUSDC = TEST_WETH_DERIVED_ETH
//     wethEntity.save()
//   })
...
//     // calculate this before calling handleSwapHelper because it updates the derivedUSDC of the tokens which will affect calculations
...
//     const totalValueLockedETH = amount0.times(newToken0DerivedUSDC).plus(amount1.times(newToken1DerivedUSDC))
...
//       ['feesUSD', feesUSD.toString()],
//       ['txCount', '1'],
//       ['derivedUSDC', newToken0DerivedUSDC.toString()],
//       ['totalValueLockedUSD', amount0.times(newToken0DerivedUSDC).times(newEthPrice).toString()],
//     ])
...
//       ['feesUSD', feesUSD.toString()],
//       ['txCount', '1'],
//       ['derivedUSDC', newToken1DerivedUSDC.toString()],
//       ['totalValueLockedUSD', amount1.times(newToken1DerivedUSDC).times(newEthPrice).toString()],
//     ])
